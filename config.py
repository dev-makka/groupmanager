...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "a3df45b8d3b710a5b15b485381f1adc8"
    OWNER_ID = "943978681"  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "ayanokoji_op"  #Just write it without the @ ex "Sawada"
